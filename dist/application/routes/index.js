...
const patient_consultation_routes_1 = require("../infrastructure/http/routes/patient-consultation-routes");
function registerRoutes(app) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        app.register(patient_consultation_routes_1.patientConsultationRoutes);
    });
}
